...
PRICING_HERO_NEW = '''<section class="price-hero"><div class="wrap price-hero-grid" data-reveal data-pricing-visual="1"><div class="price-hero-copy"><span class="price-kicker">Стоимость услуг</span><h1>Цены на <em>охранные услуги</em></h1><p class="price-lead">Единый каталог ориентировочных тарифов. Выберите тип объекта или услугу. Точный расчёт делаем после уточнения режима, количества постов, площади и задач.</p><div class="price-actions"><a class="btn btn-gold" href="#objects">Подобрать по объекту</a><a class="btn btn-line" href="/kontakty/">Получить точный расчёт</a></div></div><figure class="price-hero-visual"><img class="price-hero-bg" src="/images/ceny-hero.svg" alt="Аналитика стоимости охранных услуг" width="1600" height="900" fetchpriority="high" decoding="async"><div class="price-brand-shield"><img src="/images/schit.png" alt="Логотип ЧОО «Рускорпорация»" loading="eager" decoding="async"><svg class="price-brand-spark" viewBox="0 0 120 140" aria-hidden="true"><path class="spark-rail" d="M60 7 107 25 102 76c-4 29-20 48-42 58-22-10-38-29-42-58L13 25 60 7Z"/><path class="spark-run spark-run-a" d="M60 7 107 25 102 76c-4 29-20 48-42 58-22-10-38-29-42-58L13 25 60 7Z"/><path class="spark-run spark-run-b" d="M60 7 107 25 102 76c-4 29-20 48-42 58-22-10-38-29-42-58L13 25 60 7Z"/><circle class="spark-head" r="3.2"><animateMotion dur="2.4s" repeatCount="indefinite" path="M60 7 107 25 102 76c-4 29-20 48-42 58-22-10-38-29-42-58L13 25 60 7Z"/></circle><circle class="spark-head spark-head-2" r="1.8"><animateMotion dur="1.2s" begin="-.55s" repeatCount="indefinite" path="M60 7 107 25 102 76c-4 29-20 48-42 58-22-10-38-29-42-58L13 25 60 7Z"/></circle></svg></div></figure></div></section>'''
PRICING_CSS = '''
/* pricing-hero-visual */
...
/* pricing-brand-shield-v1 */
.price-hero-visual>.price-hero-bg{display:block;width:100%;height:100%;object-fit:cover;object-position:center;filter:saturate(.96) contrast(1.03)}
.price-brand-shield{position:absolute;z-index:3;left:69.4%;top:48%;width:31%;aspect-ratio:1/1.16;transform:translate(-50%,-50%);display:grid;place-items:center;pointer-events:none}.price-brand-shield>img{position:relative;z-index:2;width:82%;height:82%;object-fit:contain;filter:drop-shadow(0 16px 32px rgba(0,0,0,.48)) drop-shadow(0 0 12px rgba(232,200,122,.24))}.price-brand-spark{position:absolute;z-index:3;inset:-6%;width:112%;height:112%;overflow:visible}.spark-rail,.spark-run{fill:none;vector-effect:non-scaling-stroke}.spark-rail{stroke:rgba(232,200,122,.24);stroke-width:1.25}.spark-run{stroke-linecap:round;stroke-linejoin:round;filter:drop-shadow(0 0 3px rgba(255,219,122,.95)) drop-shadow(0 0 8px rgba(255,139,36,.78));animation:priceSparkRun 1.8s linear infinite}.spark-run-a{stroke:#ffe8a8;stroke-width:2.4;stroke-dasharray:10 30}.spark-run-b{stroke:#ff9f43;stroke-width:3.1;stroke-dasharray:2 24;animation-duration:.9s;opacity:.9}.spark-head{fill:#fff6cf;filter:drop-shadow(0 0 3px #fff0ad) drop-shadow(0 0 9px #ff8c2f)}.spark-head-2{fill:#ffb65a;opacity:.9}.price-brand-shield::after{content:"";position:absolute;inset:9%;z-index:1;border-radius:50%;background:radial-gradient(circle,rgba(232,200,122,.12),transparent 68%);filter:blur(6px)}
@keyframes priceSparkRun{to{stroke-dashoffset:-160}}
@media(max-width:960px){.price-brand-shield{width:29%;left:69%;top:48%}}
@media(max-width:700px){.price-brand-shield{width:34%;left:70%;top:49%}.spark-run{filter:drop-shadow(0 0 2px rgba(255,219,122,.9)) drop-shadow(0 0 5px rgba(255,139,36,.68))}}
@media(prefers-reduced-motion:reduce){.spark-run{animation:none}.spark-head{display:none}}
'''
